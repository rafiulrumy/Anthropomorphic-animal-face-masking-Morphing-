function [fixedPoints] = fixedPoints(im1)
...
%MOUTH DETECTION:
%To detect Mouth
MouthDetect = vision.CascadeObjectDetector('Mouth','MergeThreshold',160);
...
EyeDetect = vision.CascadeObjectDetector('RightEyeCART','MergeThreshold',32);
%Read the input Image
%I = imread('1.jpg');
...
%To detect Eyes
%EyeDetect = vision.CascadeObjectDetector('EyePairBig');
EyeDetect = vision.CascadeObjectDetector('LeftEyeCART','MergeThreshold',16);
...
fixedPoints = double([circle_x_face',circle_y_face';...
